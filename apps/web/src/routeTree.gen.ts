...
const CommunityChangeRoute = CommunityChangeRouteImport.update({
  id: '/community-change',
  path: '/community-change',
  getParentRoute: () => rootRouteImport,
} as any)
const BeatMeetingRoute = BeatMeetingRouteImport.update({
  id: '/beat-meeting',
  path: '/beat-meeting',
  getParentRoute: () => rootRouteImport,
} as any)
...
declare module '@tanstack/react-router' {
  interface FileRoutesByPath {
    ...
    '/community-change': {
      id: '/community-change'
      path: '/community-change'
      fullPath: '/community-change'
      preLoaderRoute: typeof CommunityChangeRouteImport
      parentRoute: typeof rootRouteImport
    }
    '/beat-meeting': {
      id: '/beat-meeting'
      path: '/beat-meeting'
      fullPath: '/beat-meeting'
